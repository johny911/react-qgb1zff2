    ...
    <div style={styles.container}>
      {screen === 'home' && (
        <div>
          ...
          <div style={styles.cardButton} onClick={() => setScreen('enter')}>
            ➕ Enter Attendance
          </div>
          <div style={styles.cardButton} onClick={() => setScreen('view')}>
            👁️ View Attendance
          </div>
        </div>
      )}
      ...
      {screen === 'enter' && (
        <div>
          ...
          {rows.map((row, index) => (
            <div key={index} style={styles.entryCard}>
              <div style={styles.entryHeader}>
                ...
                <button onClick={() => deleteRow(index)} style={styles.trash}>
                  🗑️
                </button>
              </div>
              <select
                ...
                value={row.teamId}
                onChange={(e) =>
                  handleRowChange(index, 'teamId', e.target.value)
                }
              >
              ...
              <select
                ...
                value={row.typeId}
                onChange={(e) =>
                  handleRowChange(index, 'typeId', e.target.value)
                }
                disabled={!row.teamId}
              >
          ...
          <div onClick={addRow} style={styles.dashedBox}>
            + Add Team
          </div>
          ...
          <button style={styles.back} onClick={() => setScreen('home')}>
            ← Back
          </button>
        </div>
      )}
      ...
      {screen === 'view' && (
        <div>
          ...
          <button style={styles.primaryBtn} onClick={fetchAttendance}>
            View
          </button>
